...
/*Table structure for table `canteentime` */

DROP TABLE IF EXISTS `canteentime`;

CREATE TABLE `canteentime` (
...
/*Data for the table `canteentime` */

insert  into `canteentime`(`id`,`user_id`,`user_name`,`date`,`flag`) values 
(8,1,'李永迈','2018-10-01',0),
(9,1,'李永迈','2018-10-02',1),
(10,13,'李新权','2018-10-01',0),
(11,13,'李新权','2018-10-02',1);
...
(1,'9999','李永迈','2018-10-23 11:27:13'),
(13,'8888','李新权','2018-10-23 11:27:37');

/*Table structure for table `other_time` */

DROP TABLE IF EXISTS `other_time`;

CREATE TABLE `other_time` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(11) DEFAULT NULL,
...
/*Data for the table `other_time` */

insert  into `other_time`(`id`,`user_id`,`date`) values 
(2,1,'2018-10-04 14:59:45'),
(3,1,'2018-10-05 14:59:50');
...
(25,2,'2018-10-01 08:58:42','2018-10-22 09:03:48',NULL),
(27,1,'2018-10-02 14:59:38','2018-10-23 15:00:01',NULL);
...
(104,1,'2018-10-18','办案加班',1),
(105,1,'2018-10-21','办案加班',0),
(106,1,'2018-10-29','办案加班',0);
...
(254,'出差人员','javascript:void(0)','0','','/resources/images/32x32/communication.png',255,3,0,0,0,0,'2018-10-22 08:57:52','2018-10-15 16:38:47'),
...
CREATE TABLE `sys_role_resource` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=669 DEFAULT CHARSET=utf8 COMMENT='角色-资源';
...
(30,2,'2018-10-02 08:58:47','2018-10-22 09:03:48',NULL),
(32,1,'2018-10-03 14:59:43','2018-10-23 15:00:01',NULL);
